...
class Pelota{
    constructor(posx,posy,color,radio){
        ...
        this.color=color;
        this.radio=radio;
        this.velox=parseInt(Math.random()*24);
        this.veloy=parseInt(Math.random()*24);
...
class bloke{
    constructor(){
        ...
        this.posy=(parseInt(Math.random()*590)+10)*-1;
        this.altura=parseInt(Math.random()*24)+20;
        this.ancho=parseInt(Math.random()*24)+20;
        this.rx=parseInt(Math.random()*10);
        this.ry=parseInt(Math.random()*10);
        this.velox=0;
        this.veloy=10;
        this.pasa=0;
