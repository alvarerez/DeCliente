// esta es la clase para el tres enraya
class tresEnRaya{
    constructor(){
        this.fin = false
        this.turno = 0;
...
//    con este metodo sabes que jugador esta jugando
    cuentaTurno(){
        this.turno++
        if(this.turno==9){
            this.empate()
...
//    utiliza este metodo para marcar
...
//    aqui hace comprobaciones para ver si hay alguna linea ganadora
    resultados(){
        for(var i=0; i<=6; i+=3){
...
//    con este metodo te comprueba si hay ganador y te dice el ganador
    compruebaResultado(){
        if(this.resultados()){
            this.ganador();
